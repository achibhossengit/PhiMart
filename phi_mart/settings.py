...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:5173',
    'https://phimart-client-achib-hossens-projects.vercel.app',
    'https://phimart-client-ruddy.vercel.app',
    'https://phimart-client-git-main-achib-hossens-projects.vercel.app'
]
...
REST_FRAMEWORK = {
    'COERCE_DECIMAL_TO_STRING': False,  # Disable coercing Decimal to string
    # 'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.PageNumberPagination', # for all views
    # 'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.LimitOffsetPagination', # for all views
    # 'PAGE_SIZE':10, # declare this one another page to ignore terminal error
...
# for ssl
FRONT_END_HOST = config('FRONT_END_HOST')
BACK_END_HOST = config('BACK_END_HOST')